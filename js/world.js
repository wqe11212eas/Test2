(function() {
    ...
    $(function() {
        ...
        function openModal(vid) {
        	...
        	modal.stop(true).removeClass('none').css({opacity:0});

        	modal.delay(20).transit({opacity:1}, 800, 'iX2', function() {
        ...
        function closeModal() {
        	...
        	modal.stop(true).transit({opacity:0}, 600, 'oX2', function() {
        		ytPlayer.pause();
        		ytPlayer.seek(0);
        ...
        $('.tablet_movie').on('click', function(e) {
        	e.preventDefault();

        	if (current === 0) {
        		openModal('b8hDuCeG1xg');
        	}
        	if (current === 1) {
        		openModal('vEj57Jd6d3A');
        	}
        });
        */
    });
